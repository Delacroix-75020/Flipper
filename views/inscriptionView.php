            ...
            <div class="card-body">
                <form method="post" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" id="prenom" name="prenom" placeholder="Votre Prenom" class="form-control" value="<?php if(isset($prenom)) { echo $prenom; } ?>" />
                    </div>
                    <div class="mb-3">
                        <label for="nom" class="form-label">Nom de Famille :</label>
                        <input type="text" id="nom" name="nom" placeholder="Votre nom" class="form-control" value="<?php if(isset($nom)) { echo $nom; } ?>" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="tel" class="form-label">Votre Bio:</label>
                        <input type="bloc" id="bio" name="bio" placeholder="Biographie" class="form-control" />
                    </div>
